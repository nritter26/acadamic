...
| **Quiz mode** | Per-language multiple-choice quizzes with instant feedback and progress tracking (35 languages, 3 difficulty levels each, 10,500+ total questions). |
