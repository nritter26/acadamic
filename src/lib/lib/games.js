export const GAME_CATALOG = [
  { id: 'typing-speed', title: 'Typing Speed', description: 'Type code snippets accurately under time pressure.', mode: 'typing' },
  { id: 'code-scramble', title: 'Code Scramble', description: 'Reorder scrambled code into a working solution.', mode: 'order' },
  { id: 'debug-the-bug', title: 'Debug The Bug', description: 'Find the broken line and fix it.', mode: 'choice' },
  { id: 'syntax-sprint', title: 'Syntax Sprint', description: 'Choose the valid syntax before time runs out.', mode: 'choice' },
  { id: 'memory-match', title: 'Memory Match', description: 'Match concepts with definitions.', mode: 'choice' },
  { id: 'speed-read', title: 'Speed Read', description: 'Read snippets and answer comprehension prompts.', mode: 'choice' },
  { id: 'race-compiler', title: 'Race Compiler', description: 'Predict compiler stages and outcomes.', mode: 'choice' },
  { id: 'syntax-swipe', title: 'Syntax Swipe', description: 'Classify syntax as valid or invalid.', mode: 'choice' },
  { id: 'code-golf', title: 'Code Golf', description: 'Solve tasks with fewer characters.', mode: 'text' },
  { id: 'binary-hex-blitz', title: 'Binary Hex Blitz', description: 'Convert between number systems.', mode: 'text' },
  { id: 'crossword', title: 'Crossword', description: 'Solve programming clue grids.', mode: 'text' },
  { id: 'regex-rally', title: 'Regex Rally', description: 'Build regular expressions for target strings.', mode: 'text' },
  { id: 'sql-join-match', title: 'SQL JOIN Match', description: 'Pick the correct JOIN for the output.', mode: 'choice' },
  { id: 'errorpedia', title: 'Errorpedia', description: 'Match errors to causes and fixes.', mode: 'choice' },
  { id: 'api-arcade', title: 'API Arcade', description: 'Assemble requests and inspect responses.', mode: 'choice' },
  { id: 'logic-ladder', title: 'Logic Ladder', description: 'Step through branching logic puzzles.', mode: 'choice' },
];
