...
const LANG_KEYWORDS = {
    ...
    lua: ['function', 'local', 'if', 'then', 'else', 'elseif', 'end', 'for', 'while', 'do', 'repeat', 'until', 'return', 'break', 'nil', 'true', 'false', 'and', 'or', 'not', 'in', 'print', 'type', 'tostring', 'tonumber', 'ipairs', 'pairs', 'next', 'select', 'unpack', 'require', 'dofile', 'loadfile', 'error', 'assert', 'pcall', 'xpcall', 'self', 'setmetatable', 'getmetatable', 'rawset', 'rawget', 'rawlen', 'rawequal', 'coroutine', '_G', '_VERSION', 'string', 'table', 'math', 'io', 'os', 'bit32', 'utf8', 'debug'],
...
function setHtmlcssFilter(filter) {
